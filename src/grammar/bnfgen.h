...
P_termdef_1 = pg_prod_create( N_termdef, T_at, T_IDENT, T_REGEX, (pgsymbol*)NULL );
P_termdef_2 = pg_prod_create( N_termdef, T_at, T_IDENT, T_STRING, (pgsymbol*)NULL );
P_termdef_3 = pg_prod_create( N_termdef, T_at, T_IDENT, (pgsymbol*)NULL );

/* Productions for productions */
P_productions_1 = pg_prod_create( N_productions, N_productions, T_pipe, N_rhs, (pgsymbol*)NULL );
P_productions_2 = pg_prod_create( N_productions, N_rhs, (pgsymbol*)NULL );

/* Productions for nontermdef */
P_nontermdef_1 = pg_prod_create( N_nontermdef, T_IDENT, T_COLON, N_productions, (pgsymbol*)NULL );
P_nontermdef_2 = pg_prod_create( N_nontermdef, T_IDENT, (pgsymbol*)NULL );

/* Productions for production */
P_production_1 = pg_prod_create( N_production, N_production, N_named_symbol, (pgsymbol*)NULL );
P_production_2 = pg_prod_create( N_production, N_named_symbol, (pgsymbol*)NULL );

/* Productions for term */
P_term_1 = pg_prod_create( N_term, T_at, T_IDENT, (pgsymbol*)NULL );

/* Productions for nonterm */
P_nonterm_1 = pg_prod_create( N_nonterm, T_IDENT, (pgsymbol*)NULL );

/* Productions for named_symbol */
P_named_symbol_1 = pg_prod_create( N_named_symbol, N_mod_symbol, T_equal, T_atIDENT, (pgsymbol*)NULL );
P_named_symbol_2 = pg_prod_create( N_named_symbol, N_mod_symbol, (pgsymbol*)NULL );

/* Productions for symbol */
P_symbol_1 = pg_prod_create( N_symbol, N_term, (pgsymbol*)NULL );
P_symbol_2 = pg_prod_create( N_symbol, N_nonterm, (pgsymbol*)NULL );

/* Productions for grammar */
P_grammar_1 = pg_prod_create( N_grammar, N_definitions, (pgsymbol*)NULL );
P_grammar_2 = pg_prod_create( N_grammar, (pgsymbol*)NULL );

/* Productions for rhs */
P_rhs_1 = pg_prod_create( N_rhs, N_production, (pgsymbol*)NULL );
P_rhs_2 = pg_prod_create( N_rhs, (pgsymbol*)NULL );

/* Productions for definitions */
P_definitions_1 = pg_prod_create( N_definitions, N_definitions, N_definition, (pgsymbol*)NULL );
P_definitions_2 = pg_prod_create( N_definitions, N_definition, (pgsymbol*)NULL );

/* Productions for definition */
P_definition_1 = pg_prod_create( N_definition, N_termdef, T_semicolon, (pgsymbol*)NULL );
P_definition_2 = pg_prod_create( N_definition, N_nontermdef, T_semicolon, (pgsymbol*)NULL );

/* Productions for mod_symbol */
P_mod_symbol_1 = pg_prod_create( N_mod_symbol, N_symbol, T_plus, (pgsymbol*)NULL );
P_mod_symbol_2 = pg_prod_create( N_mod_symbol, N_symbol, T_star, (pgsymbol*)NULL );
P_mod_symbol_3 = pg_prod_create( N_mod_symbol, N_symbol, T_quest, (pgsymbol*)NULL );
P_mod_symbol_4 = pg_prod_create( N_mod_symbol, N_symbol, (pgsymbol*)NULL );
